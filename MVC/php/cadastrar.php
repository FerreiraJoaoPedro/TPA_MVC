...
<head>
    <meta charset="UTF-8">
    <title>CADASTRO DOS BOLO MTO LOKO MERMAO</title>
...
<div class="main">
    <div class="form">
        ...
        <form action="cadastrar.php?codigo=<?php ?>" method="post" class="formulario">
            <div class="alignment">
                <h2>Cadastre seu bolo</h2>
            </div>
            <div class="flex">
                <div class="col-lg-12">
                    <p class="p">Sabor:</p>
            ...
            <div class="alignment">
                <button class="botao_salvar" type="submit" name="Cadastrar" id="cadastrar">Salvar</button>
